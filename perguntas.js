export const perguntas = [
    {
        enunciado: "Quando voce sai da escola, voce se depara com uma nova tecnologia que responde todas as suas duvidas, qual o seu primeiro pensamento?",
        alternativas: [
            {
                texto: "Assustador!",
                afirmacao: [
                    "No inico teve medo do que essa nova tecnologia pode fazer. ",
                    "Ficou assustado com a velocidade do avanço da nova tecnologia."
                ],
                proxima: 1,
            },
            {
                texto: "Muito top!",
                afirmacao: [
                    "Pensou em como usar a IA no seu dia a dia.",
                    "Pensou em como a IA pode te ajudar a fazer as tarefas diarias."
                ],
                proxima: 2,
            },
        ]
    ...
    {
        enunciado: "Utilizar a IA pode ser aterrorizante, uma professoea de tecnologia de uma escola decide fazer uma sequencia de aulas sobre a IA e passa um trabalho pra turma fazer, qual a sua atitude?"
        alternativas: [
            {
                texto: "Utilizar ferramenta de busca pra que ajude encontrar informaçoes para o trabalho e explicar com uma linguagem que facilite o entendimento.",
                afirmacao: [
                    "Conseguiu buscar informaçoes uteis.",
                    "A IA pode ajudar a encontrar informaçoes uteis e de forma rapida.",
                    "A IA consegue explicar conteudos complicados de uma forma mais facil."
                ],
                proxima: 3,
            },
            {
                texto: "Escrever o trabalho junto com os seus colegas fazendo pesquisas na internet e conhecimentos próprios sobre o tema.",
                afirmacao: [
                    "Teve felicidade de utilizar seus proprios recursos no trabalho.",
                    "",
